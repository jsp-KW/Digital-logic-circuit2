...
vlog -vlog01compat -work work +incdir+C:/intelFPGA_lite/18.1/Assignment9 {C:/intelFPGA_lite/18.1/Assignment9/cal_output_logic.v}
...
vlog -vlog01compat -work work +incdir+C:/intelFPGA_lite/18.1/Assignment9 {C:/intelFPGA_lite/18.1/Assignment9/tb_cal_output_logic.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L rtl_work -L work -voptargs="+acc"  tb_cal_output_logic
